...
---
```{r}
#Exercice de maison 11:

source("C:/Users/HP/Desktop/ISEP2CoursR2024/Homework 7.R")
Table_de_conversion <- read_excel("C:/Users/HP/Desktop/ISEP2CoursR2024/Base/Table de conversion phase 2.xlsx")
...
# Les cas de non-matching peuvent être expliqués par des céréales achetées mais consommées soit avec une unité ou une taille différente de l'achat soit avec une unité et une taille différente de l'achat
